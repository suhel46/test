...
jvm_mem=${JAVA_MEM:-" "}
jvm_opts=${JAVA_OPTS:-"-server -XX:HeapDumpPath=/var/log/hello-microservice-java/heap-dump-%p.hprof"}
arguments=${ARGUMENTS:-" --package.name=hello-microservice-java --package.directory=hello-microservice-java"}
...
mkdir -p /var/log/hello-microservice-java; echo "heap dumps  /var/log/hello-microservice-java/heap-dump-<pid>.hprof"

java ${jvm_opts} ${jvm_gc} ${jvm_mem} ${proxy_params} -jar /data/hello-microservice-java.jar ${arguments}
