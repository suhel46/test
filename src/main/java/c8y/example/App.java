...
public class App {
    ...
    */
    ...
    private void init () {
        ...
        c8yEnv = new HashMap<String, String>();
    ...
    */
    public EventRepresentation createLocationUpdateEvent (String ip) {
        ...
        String apiURL = "http://api.ipstack.com/" + ip + "?access_key=" + c8yEnv.get("ipstack.key");
        Location location = rest.getForObject(apiURL, Location.class);
    ...
    public ArrayList<Object> getLocations (@RequestParam(value = "max", defaultValue = "5") int max) {
    	EventFilter filter = new EventFilter().byType("c8y_LocationUpdate");
        ArrayList<Object> locations = new ArrayList<Object>();
        PagedEventCollectionRepresentation eventCollection =
        		platform.getEventApi().getEventsByFilter(filter).get(max);
